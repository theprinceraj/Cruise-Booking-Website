            ...
            {isLoginForm ? (
                <div className="flex items-center justify-center" style={{marginTop: 60}}>
                    ...
                    <form
                        ...
                        <h3 class="text-3xl font-medium text-white text-center" style={{
                            color:"white"
                        }}>Login</h3>

                        <label for="username" class="block mt-8 text-white text-lg font-medium" style={{color: "white"}}>
                            Username
                        </label>
                        <input
                            type="text"
                        ...
                        <label for="password" class="block mt-8 text-white text-lg font-medium" style={{color: "white"}}>
                            Password
                        </label>
                        <input
                            type="password"
                        ...
                        <button class="w-full mt-12 bg-white text-[#080710] py-3 rounded-md font-semibold hover:bg-gray-200" style={{color: "white"}}>
                            Submit
                        </button>
                ...
                <div className="flex items-center justify-center" style={{ marginTop: 60}}>
                 {/* form changes -> relative removed, height changed(480px), border border-white/10 removed, shadow-xl removed, bg-white/10 removed */}
                    <form
                        ...
                        style={{ border:"5px solid grey" }}
                        >
                        <h3 class="text-3xl font-medium text-white text-center" style={{color: "white"}}>Signup</h3>
