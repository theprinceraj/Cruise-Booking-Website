        ...
        <>
            ...
            {isLoginForm ? (
                <div className="flex items-center justify-center">
                    <form
                        class="relative w-[400px] h-[520px] bg-white/10 backdrop-blur-sm rounded-2xl border border-white/10 shadow-xl p-12"
                ...
                <div className="flex items-center justify-center">
                    <form
                        class="relative w-[400px] h-[520px] bg-white/10 backdrop-blur-sm rounded-2xl border border-white/10 shadow-xl p-12"
                        style={{ backgroundColor: "white" }}>
                        <h3 class="text-3xl font-medium text-white text-center">Signup Here</h3>
